...
#define INT_DATA( Parm )	( Parm->ParameterData.IntegerData )
	...
	NdisReadPciSlotInformation( DriverHandle, SlotNumber,
								PCI_VENDOR_ID_REGISTER, &id, sizeof id );
	...
	NdisReadPciSlotInformation( DriverHandle, SlotNumber,
								PCI_INTERRUPT_REGISTER, &InterruptNumber, 1 );
	...
	Debug( 7, this, "Adapter: MAC=%02X-%02X-%02X-%02X-%02X-%02X", MACAddress[0],
		   ...
		   MACAddress[5] );
	Debug( 7, this,
		   "HLDC: CRC%s, Fill=%s, Pol=%s, RB=%s, WB=%s, XQL=%u, RQL=%u", HdlcCfg.crc16 ? "16" : "32",
		   HdlcCfg.fill_7e ? "7E" : "FF", HdlcCfg.inv ? "Neg" : "Pos",
		   HdlcCfg.rburst ? "On" : "Off", HdlcCfg.wburst ? "On" : "Off",
