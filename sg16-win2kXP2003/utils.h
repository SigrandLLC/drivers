...
/* -----------------------------------------------------------------------------
 *    DMA packet queue descriptor Queue is made in ring style. Maintained in
 *    correspondence with related TBD/RBD ring.
 ------------------------------------------------------------------------------- */
class	DmaQueue
{
...
/* -----------------------------------------------------------------------------
 *    !!!Assume (sizeof (PacketAddon) <= sizeof
 *    (_NDIS_PACKET::MiniportReservedEx));
 ------------------------------------------------------------------------------- */
class	PacketList
{	/* Linked packet list */
